<?php
    $middleInitial = isset($data['user_profile'][0]['middle_name']) ? ucfirst($data['user_profile'][0]['middle_name']) : null;
    $suffix = isset($data['user_profile'][0]['suffix']) ? ucfirst($data['user_profile'][0]['suffix']) : null;
?>
                ...
                <dl class="row desc">
                    <?php
                        if(isset($data['user_profile'])) {
                            ...
                            $profile .= "<dd class='col-7'>". $data['user_profile'][0]['email'] ."</dd>";
                            $profile .= "<dt class='col-5'>Name</dt>";
                            $profile .= "<dd class='col-7'>". ucfirst($data['user_profile'][0]['last_name']) .', '. ucfirst($data['user_profile'][0]['first_name']) . ' ' .$middleInitial. ' ' .$suffix."</dd>";
                            $profile .= "<dt class='col-5'>Mobile Number</dt>";
                            $profile .= "<dd class='col-7'>". $data['user_profile'][0]['mobile_number'] ."</dd>";
                            echo $profile;
                        }
                    ?>
                </dl>
