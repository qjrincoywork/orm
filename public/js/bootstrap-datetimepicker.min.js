    ...
    var a = function(a, n) {
        var r, i, o, s, d, l, p, c, u, f = {},
            ...
            E = function() {
                var t, a, r, i = e("<div>").addClass("timepicker-hours").append(e("<table>").addClass("table-condensed")),
                    ...
                    }).addClass("btn").attr("data-action", "decrementSeconds").append(e("<span>").addClass(n.icons.down))))), s || (t.append(e("<td>").addClass("separator")), a.append(e("<td>").append(e("<button>").addClass("btn btn-primary").attr({
            ...
            B = function(e) {
                y && (e && (p = Math.max(b, Math.min(3, p + e))), y.find(".datepicker > div").hide().filter(".datepicker-" + w[p].clsName).show())
            },
            j = function(t, a) {
            ...
            A = function() {
                var a, o, s, d, l, p, c = y.find(".datepicker-days"),
                    u = c.find("th"),
                    f = [],
                    h = [];
                if (P()) {
                    for (u.eq(0).find("span").attr("title", n.tooltips.prevMonth), u.eq(1).attr("title", n.tooltips.selectMonth), u.eq(2).find("span").attr("title", n.tooltips.nextMonth), c.find(".disabled").removeClass("disabled"), u.eq(1).text(i.format(n.dayViewHeaderFormat)), j(i.clone().subtract(1, "M"), "M") || u.eq(0).addClass("disabled"), j(i.clone().add(1, "M"), "M") || u.eq(2).addClass("disabled"), a = i.clone().startOf("M").startOf("w").startOf("d"), s = 0; s < 42; s++) 0 === a.weekday() && (o = e("<tr>"), n.calendarWeeks && o.append('<td class="cw">' + a.week() + "</td>"), f.push(o)), h = ["day"], a.isBefore(i, "M") && h.push("old"), a.isAfter(i, "M") && h.push("new"), a.isSame(r, "d") && !m && h.push("active"), j(a, "d") || h.push("disabled"), a.isSame(M(), "d") && h.push("today"), 0 !== a.day() && 6 !== a.day() || h.push("weekend"), Y({
                        type: "dp.classify",
                        date: a,
                        classNames: h
                    }), o.append('<td data-action="selectDay" data-day="' + a.format("L") + '" class="' + h.join(" ") + '">' + a.date() + "</td>"), a.add(1, "d");
                    c.find("tbody").empty().append(f), d = y.find(".datepicker-months"), l = d.find("th"), p = d.find("tbody").find("span"), l.eq(0).find("span").attr("title", n.tooltips.prevYear), l.eq(1).attr("title", n.tooltips.selectYear), l.eq(2).find("span").attr("title", n.tooltips.nextYear), d.find(".disabled").removeClass("disabled"), j(i.clone().subtract(1, "y"), "y") || l.eq(0).addClass("disabled"), l.eq(1).text(i.year()), j(i.clone().add(1, "y"), "y") || l.eq(2).addClass("disabled"), p.removeClass("active"), r.isSame(i, "y") && !m && p.eq(r.month()).addClass("active"), p.each(function(t) {
                ...
                s || (t = y.find(".timepicker [data-action=togglePeriod]"), a = r.clone().add(r.hours() >= 12 ? -12 : 12, "h"), t.text(r.format("A")), j(a, "h") ? t.removeClass("disabled") : t.addClass("disabled")), o.filter("[data-time-component=hours]").text(r.format(s ? "HH" : "hh")), o.filter("[data-time-component=minutes]").text(r.format("mm")), o.filter("[data-time-component=seconds]").text(r.format("ss")),
                    function() {
                        var t = y.find(".timepicker-hours table"),
                            ...
                            n = [],
                            r = e("<tr>");
                        for (i.hour() > 11 && !s && a.hour(12); a.isSame(i, "d") && (s || i.hour() < 12 && a.hour() < 12 || i.hour() > 11);) a.hour() % 4 == 0 && (r = e("<tr>"), n.push(r)), r.append('<td data-action="selectHour" class="hour' + (j(a, "h") ? "" : " disabled") + '">' + a.format(s ? "HH" : "hh") + "</td>"), a.add(1, "h");
                        t.empty().append(n)
                    }(),
                    function() {
                        for (var t = y.find(".timepicker-minutes table"), a = i.clone().startOf("h"), r = [], o = e("<tr>"), s = 1 === n.stepping ? 5 : n.stepping; i.isSame(a, "h");) a.minute() % (4 * s) == 0 && (o = e("<tr>"), r.push(o)), o.append('<td data-action="selectMinute" class="minute' + (j(a, "m") ? "" : " disabled") + '">' + a.format("mm") + "</td>"), a.add(s, "m");
                        t.empty().append(r)
                    }(),
                    function() {
                        for (var t = y.find(".timepicker-seconds table"), a = i.clone().startOf("m"), n = [], r = e("<tr>"); i.isSame(a, "m");) a.second() % 20 == 0 && (r = e("<tr>"), n.push(r)), r.append('<td data-action="selectSecond" class="second' + (j(a, "s") ? "" : " disabled") + '">' + a.format("ss") + "</td>"), a.add(5, "s");
                        t.empty().append(n)
                    }()
            },
            L = function() {
            ...
            W = function(e) {
                var t = m ? null : r;
                if (!e) return m = !0, o.val(""), a.data("date", ""), Y({
                    type: "dp.change",
                    date: !1,
                    oldDate: t
                }), void L();
                ...
                j(e) ? (i = (r = e).clone(), o.val(r.format(d)), a.data("date", r.format(d)), m = !1, L(), Y({
                    type: "dp.change",
                    date: r.clone(),
                    oldDate: t
                })) : (n.keepInvalid ? Y({
            ...
            z = function() {
                ...
                }), t ? f : (h && h.hasClass("btn") && h.toggleClass("active"), y.hide(), e(window).off("resize", I), y.off("click", "[data-action]"), y.off("mousedown", !1), y.remove(), y = !1, Y({
                    type: "dp.hide",
                    date: r.clone()
            ...
            Z = {
                next: function() {
                    var e = w[p].navFnc;
                    i.add(w[p].navStep, e), A(), q(e)
                },
                previous: function() {
                    var e = w[p].navFnc;
                    i.subtract(w[p].navStep, e), A(), q(e)
                },
            ...
            Q = function() {
                var t;
                return o.prop("disabled") || !n.ignoreReadonly && o.prop("readonly") || y ? f : (void 0 !== o.val() && 0 !== o.val().trim().length ? W(V(o.val().trim())) : m && n.useCurrent && (n.inline || o.is("input") && 0 === o.val().trim().length) && (t = M(), "string" == typeof n.useCurrent && (t = {
                    year: function(e) {
                ...
                }(), y.find(".timepicker-hours").hide(), y.find(".timepicker-minutes").hide(), y.find(".timepicker-seconds").hide(), L(), B(), e(window).on("resize", I), y.on("click", "[data-action]", R), y.on("mousedown", !1), h && h.hasClass("btn") && h.toggleClass("active"), I(), y.show(), n.focusOnShow && !o.is(":focus") && o.focus(), Y({
                    type: "dp.show"
                }), f)
            },
            U = function() {
            ...
            G = function(e) {
                ...
                for (t in n.keyBinds)
                    if (n.keyBinds.hasOwnProperty(t) && "function" == typeof n.keyBinds[t] && (r = t.split(" "), r.length === s.length && C[l] === r[r.length - 1])) {
            ...
            _ = function() {
                ...
                }), (l = n.extraFormats ? n.extraFormats.slice() : []).indexOf(e) < 0 && l.indexOf(d) < 0 && l.push(d), s = d.toLowerCase().indexOf("a") < 1 && d.replace(/\[.*?\]/g, "").indexOf("h") < 1, S("y") && (b = 2), S("M") && (b = 1), S("d") && (b = 0), p = Math.max(b, p), m || W(r)
            };
        if (f.destroy = function() {
                z(), o.off({
                    ...
                    focus: Q
                }) : h && (h.off("click", U), h.off("mousedown", !1)), a.removeData("DateTimePicker"), a.removeData("date")
            }, f.toggle = U, f.show = Q, f.hide = z, f.disable = function() {
                return z(), h && h.hasClass("btn") && h.addClass("disabled"), o.prop("disabled", !0), f
            }, f.enable = function() {
                return h && h.hasClass("btn") && h.removeClass("disabled"), o.prop("disabled", !1), f
                ...
                return n.viewMode = e, p = Math.max(g.indexOf(e), b), B(), f
        ...
        else if (o = a.find(n.datepickerInput), 0 === o.length) o = a.find("input");
        else if (!o.is("input")) throw new Error('CSS class "' + n.datepickerInput + '" cannot be applied to non input element');
        if (a.hasClass("input-group") && (h = 0 === a.find(".datepickerbutton").length ? a.find(".input-group-addon") : a.find(".datepickerbutton")), !n.inline && !o.is("input")) throw new Error("Could not initialize DateTimePicker without an input element");
        return r = M(), i = r.clone(), e.extend(!0, n, (u = {}, (c = a.is("input") || n.inline ? a.data() : a.find("input").data()).dateOptions && c.dateOptions instanceof Object && (u = e.extend(!0, u, c.dateOptions)), e.each(n, function(e) {
            ...
            focus: Q
        }) : h && (h.on("click", U), h.on("mousedown", !1)), o.prop("disabled") && f.disable(), o.is("input") && 0 !== o.val().trim().length ? W(V(o.val().trim())) : n.defaultDate && void 0 === o.attr("placeholder") && W(n.defaultDate), n.inline && Q(), f
    };
